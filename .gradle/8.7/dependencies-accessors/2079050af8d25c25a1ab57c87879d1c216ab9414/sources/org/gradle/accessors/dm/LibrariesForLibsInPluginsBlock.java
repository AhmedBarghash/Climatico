...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>navhost</b> with <b>androidx.navigation:navigation-compose</b> coordinates and
     * with version reference <b>navHostVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getNavhost() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("navhost");
    }
    ...
    /**
     * Dependency provider for <b>okhttpCore</b> with <b>com.squareup.okhttp3:okhttp</b> coordinates and
     * with version reference <b>okhttp</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getOkhttpCore() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("okhttpCore");
    }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>reflection</b> with <b>org.jetbrains.kotlin:kotlin-reflect</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getReflection() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kotlin.reflection");
        }
    ...
    public static class SecurityLibraryAccessors extends SubDependencyFactory {
        private final SecurityCryptoLibraryAccessors laccForSecurityCryptoLibraryAccessors = new SecurityCryptoLibraryAccessors(owner);

        public SecurityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>security.crypto</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SecurityCryptoLibraryAccessors getCrypto() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSecurityCryptoLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SecurityCryptoLibraryAccessors extends SubDependencyFactory {

        public SecurityCryptoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.security:security-crypto-ktx</b> coordinates and
         * with version reference <b>securityCryptoKtxVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("security.crypto.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPermissions</b> with value <b>0.29.2-rc</b>
         * <p>
        ...
        /**
         * Version alias <b>gradle</b> with value <b>7.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navHostVersion</b> with value <b>2.7.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNavHostVersion() { return getVersion("navHostVersion"); }
        ...
        /**
         * Version alias <b>securityCryptoKtxVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSecurityCryptoKtxVersion() { return getVersion("securityCryptoKtxVersion"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>hilt</b> which contains the following dependencies:
         * <ul>
         ...
         *    <li>com.github.mrmike:ok2curl</li>
